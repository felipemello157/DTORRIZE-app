      ...
      <div className="max-w-4xl mx-auto p-6 pb-24 relative z-10">
        ...
        <div className="mb-8">
          <button
            ...
            className="flex items-center gap-2 text-white/50 hover:text-white font-medium mb-4 transition-colors"
          >
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-coral to-brand-orange flex items-center justify-center shadow-lg shadow-brand-coral/20">
              <GraduationCap className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-black text-white">Cadastro de Instituição</h1>
              <p className="text-gray-400">Universidades, faculdades e centros de ensino</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {[1, 2, 3].map((etapa) => (
              <React.Fragment key={etapa}>
                <div className={`flex-1 h-2 rounded-full transition-all ${etapa <= etapaAtual ? "bg-gradient-to-r from-brand-coral to-brand-orange" : "bg-white/10"
                  }`} />
          ...
          <div className="flex justify-between mt-2 text-sm font-semibold text-gray-400">
            <span className={etapaAtual === 1 ? "text-brand-coral" : ""}>1. Dados</span>
            <span className={etapaAtual === 2 ? "text-brand-coral" : ""}>2. Contato</span>
            <span className={etapaAtual === 3 ? "text-brand-coral" : ""}>3. Endereço</span>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {etapaAtual === 1 && (
            <motion.div
              ...
              exit={{ opacity: 0, x: -20 }}
              className="bg-[#13132B]/80 backdrop-blur-sm border border-white/10 rounded-3xl shadow-xl p-6 space-y-6"
            >
              <div className="flex items-center gap-3 mb-4">
                <Building2 className="w-6 h-6 text-brand-coral" />
                <h2 className="text-xl font-black text-white">Dados da Instituição</h2>
              </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {areasOpcoes.map((area) => (
                      <button
                        ...
                        className={`px-6 py-3 rounded-xl font-bold transition-all ${formData.areas.includes(area.value)
                            ? "bg-gradient-to-r from-brand-coral to-brand-orange text-white shadow-lg"
                            : "bg-[#0a0a1a] border border-white/10 text-gray-400 hover:bg-white/5"
                          }`}
                      >
                        {area.label}
                      </button>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {modalidadesOpcoes.map((mod) => (
                      <button
                        ...
                        className={`px-6 py-3 rounded-xl font-bold transition-all ${formData.modalidades.includes(mod.value)
                            ? "bg-gradient-to-r from-brand-coral to-brand-orange text-white shadow-lg"
                            : "bg-[#0a0a1a] border border-white/10 text-gray-400 hover:bg-white/5"
                          }`}
                      >
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-brand-coral to-brand-orange text-white font-bold rounded-2xl shadow-lg hover:shadow-brand-coral/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
              >
                Continuar
          ...
          {etapaAtual === 2 && (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-black text-white">Informações de Contato</h2>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={proximaEtapa}
                  className="flex-1 py-4 bg-gradient-to-r from-brand-coral to-brand-orange text-white font-bold rounded-2xl shadow-lg hover:shadow-brand-coral/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                >
                  Continuar
                  <ChevronRight className="w-5 h-5" />
                </button>
          ...
          {etapaAtual === 3 && (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-black text-white">Endereço e Documentos</h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-4 bg-[#0a0a1a] border border-white/10 rounded-xl text-white placeholder-gray-600 focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all outline-none disabled:opacity-50"
                  />
                  {buscandoCep && <p className="text-sm text-brand-coral mt-1">Buscando CEP...</p>}
                </div>
              ...
              <div className="space-y-4 pt-4 border-t border-white/10">
                ...
                <div>
                  ...
                  <label
                    htmlFor="logo-upload"
                    className={`flex items-center justify-center gap-3 w-full px-4 py-6 border-2 border-dashed border-white/20 bg-[#0a0a1a] rounded-xl cursor-pointer hover:border-brand-coral/50 hover:bg-white/5 transition-all ${uploadingLogo ? "opacity-50 cursor-not-allowed" : ""
                      }`}
                  >
                    {uploadingLogo ? (
                      <>
                      ...
                      <>
                        ...
                        <span className="text-gray-400 font-medium">Clique para enviar logo (máx. 5MB)</span>
                      </>
                    )}
                  </label>
                </div>
                ...
                <div>
                  ...
                  <label
                    htmlFor="doc-upload"
                    className={`flex items-center justify-center gap-3 w-full px-4 py-6 border-2 border-dashed border-white/20 bg-[#0a0a1a] rounded-xl cursor-pointer hover:border-brand-coral/50 hover:bg-white/5 transition-all ${uploadingDoc ? "opacity-50 cursor-not-allowed" : ""
                      }`}
                  >
                    {uploadingDoc ? (
                      <>
                      ...
                      <>
                        <Upload className="w-6 h-6 text-gray-400" />
                        <span className="text-gray-400 font-medium">Clique para enviar documento (máx. 10MB)</span>
                      </>
                    )}
                  </label>
                </div>
              ...
              <div className="bg-brand-coral/5 border border-brand-coral/20 rounded-xl p-4">
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    className="mt-1 w-5 h-5 text-brand-coral rounded bg-[#0a0a1a] focus:ring-brand-coral"
                  />
