...
export default function ConfirmarSubstituicaoTimer() {
    ...
    return (
      <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-xl font-bold text-white">Candidatura não encontrada</p>
        </div>
      </div>
    );
  }
  ...
  if (candidatura.status !== 'ESCOLHIDO' || timerExpirou) {
    return (
      <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center p-4">
        <div className="text-center">
          <XCircle className="w-16 h-16 text-red-500 mx-auto mb-4" />
          <p className="text-xl font-bold text-white mb-2">Tempo Esgotado</p>
          <p className="text-gray-400 mb-6">A vaga foi oferecida ao próximo candidato</p>
          <button
            onClick={() => navigate("/MinhasCandidaturasSubstituicao")}
            className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-600 text-white font-bold rounded-xl"
          >
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] pb-24">
      <div className="bg-gradient-to-r from-yellow-600 via-orange-600 to-red-600 py-8 mb-6">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur flex items-center justify-center text-4xl mx-auto mb-4 border border-white/20">
            🎉
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        ...
        <motion.div
          ...
          className="bg-[#13132B] border border-white/10 rounded-3xl shadow-xl p-8"
        >
          <h2 className="text-2xl font-black text-white mb-6">Detalhes da Substituição</h2>

          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <MapPin className="w-5 h-5 text-blue-500" />
                <p className="text-sm font-semibold text-gray-400">Clínica</p>
              </div>
              <p className="text-xl font-bold text-white">{substituicao.nome_clinica}</p>
              <p className="text-gray-400">{substituicao.endereco_completo}</p>
              <p className="text-gray-400">{substituicao.cidade}/{substituicao.uf}</p>
            </div>

            <div>
              <div className="flex items-center gap-2 mb-2">
                <Calendar className="w-5 h-5 text-brand-orange" />
                <p className="text-sm font-semibold text-gray-400">Quando</p>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm font-semibold text-gray-400">Remuneração</p>
              </div>
              <p className="text-lg font-bold text-white">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm font-semibold text-gray-400">Contato</p>
              </div>
              <p className="font-bold text-white">{substituicao.responsavel_nome}</p>
              <p className="text-gray-400">{substituicao.responsavel_cargo}</p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="py-5 bg-gray-800 border border-white/10 text-gray-300 font-bold rounded-2xl hover:bg-gray-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="py-5 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-black text-lg rounded-2xl shadow-lg hover:shadow-green-500/20 hover:scale-[1.02] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
