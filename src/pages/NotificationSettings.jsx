  ...
  return (
    <div className="flex items-center justify-between p-4 border-b border-white/5 last:border-0 hover:bg-white/5 transition-colors">
      ...
      <button
        ...
        className={`relative w-14 h-8 rounded-full transition-all duration-300 flex-shrink-0 ml-4 ${enabled
            ? "bg-brand-primary"
            : "bg-gray-700"
          }`}
      >
        <div
          className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow-md transition-all duration-300 ${enabled ? "left-7" : "left-1"
            }`}
        />
      </button>
    </div>
    ...
    return (
      <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 font-semibold">Carregando configurações...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#0a0a1a] text-white">
      <div className="px-4 pt-6 pb-6 max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-2">
          <div className="w-12 h-12 rounded-2xl bg-brand-primary/20 flex items-center justify-center shadow-lg">
            <Bell className="w-6 h-6 text-brand-primary" />
          </div>
          <div>
            <h1 className="text-2xl font-black text-white">Configurações de Notificações</h1>
            <p className="text-gray-400 mt-1">Escolha como quer ser notificado</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 pb-32">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center text-blue-400 shadow-md">
              <Smartphone className="w-5 h-5" />
            </div>
            <h2 className="text-lg font-bold text-white">Notificações Push</h2>
          </div>

          <div className="bg-[#13132B] rounded-2xl shadow-lg overflow-hidden border border-white/5">
            <Toggle
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-purple-500/20 flex items-center justify-center text-purple-400 shadow-md">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-green-500/20 flex items-center justify-center text-green-400 shadow-md">
              <MessageCircle className="w-5 h-5" />
            </div>
            <h2 className="text-lg font-bold text-white">Notificações por WhatsApp</h2>
          </div>
          ...
          <div className="bg-[#13132B] rounded-2xl shadow-lg overflow-hidden border border-white/5">
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex-1">
                  <p className="font-semibold text-white">Receber por WhatsApp 💚</p>
                  <p className="text-sm text-gray-400 mt-0.5">Apenas para vagas Super Jobs</p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className={`relative w-14 h-8 rounded-full transition-all duration-300 flex-shrink-0 ${preferences.receber_whatsapp
                      ? "bg-green-500"
                      : "bg-gray-700"
                    }`}
                >
                  <div
                    className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow-md transition-all duration-300 ${preferences.receber_whatsapp ? "left-7" : "left-1"
                      }`}
                  />
                </button>
              </div>
              ...
              {preferences.receber_whatsapp && (
                ...
                >
                  ...
                  <input
                    ...
                    maxLength={15}
                    className="w-full px-4 py-3 bg-[#0a0a1a] border border-white/10 rounded-xl text-white placeholder-gray-600 focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all outline-none"
                  />
        ...
        >
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded-lg bg-brand-primary flex items-center justify-center text-white flex-shrink-0">
              <CheckCircle2 className="w-5 h-5" />
            </div>
            <div>
              <h3 className="font-bold text-white mb-1">Privacidade</h3>
      ...
      >
        <div className="max-w-2xl mx-auto">
          <button
            ...
            className="w-full py-4 bg-brand-primary text-white font-bold text-lg rounded-2xl shadow-[0_0_20px_rgba(255,102,0,0.4)] hover:shadow-[0_0_30px_rgba(255,102,0,0.6)] hover:scale-[1.02] transition-all disabled:opacity-50 flex items-center justify-center gap-2 border border-brand-primary/50"
          >
