    ...
    return (
      <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center p-4 overflow-hidden relative">
        ...
        >
          ...
          <p className="text-gray-400 mb-2">Sua opinião ajuda a construir uma comunidade melhor</p>
    ...
    <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center p-4 py-8 overflow-hidden relative">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-white mb-2">Avaliar Profissional</h1>
          <p className="text-gray-400">Como foi a experiência?</p>
        </div>

        {/* Info do Profissional */}
        {professional && (
          <div className="bg-[#0a0a1a] rounded-2xl p-4 mb-6 border border-white/5 flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-white text-lg">{professional.nome_completo}</h3>
