...
export default function CadastroFornecedor() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] text-white overflow-x-hidden pb-12">
      {/* Background Ambience */}
      ...
      <div className="relative bg-gradient-to-r from-brand-coral/20 to-brand-orange/20 border-b border-white/10 p-8 pt-12">
        <div className="absolute top-0 left-0 w-full h-full bg-[#0a0a1a]/50 backdrop-blur-sm z-0"></div>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-white/50 text-lg">Etapa {etapa} de 3: <span className="text-white">{etapas[etapa - 1].titulo}</span></p>
        </div>
      </div>

      {/* Progress Bar */}
      <div className="max-w-4xl mx-auto px-4 -mt-8 relative z-20">
        <div className="bg-[#13132B] border border-white/10 rounded-3xl shadow-xl p-4">
              ...
              return (
                <React.Fragment key={e.numero}>
                  <div className="flex flex-col items-center">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold transition-all border-2 ${concluido ? "bg-green-500 border-green-500 text-white" :
                        ativo ? "bg-gradient-to-r from-brand-coral to-brand-orange border-brand-coral text-white" :
                          "bg-transparent border-white/10 text-white/30"
                      }`}>
                      {concluido ? <Check className="w-6 h-6" /> : <Icon className="w-6 h-6" />}
                    </div>
                    <span className={`text-xs mt-2 font-medium hidden md:block ${ativo ? "text-brand-coral" : "text-white/30"
                      }`}>
                      {e.titulo}
                    </span>
                  </div>
                  {index < etapas.length - 1 && (
                    <div className={`flex-1 h-1 mx-2 rounded-full transition-all ${concluido ? "bg-green-500" : "bg-white/10"
                      }`} />
                  )}
                </React.Fragment>
              );
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8 relative z-10">
        ...
        {etapa === 1 && (
          <div className="bg-[#13132B]/80 backdrop-blur-sm border border-white/10 rounded-3xl shadow-xl p-6 space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400">Informações sobre seu negócio</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-4 bg-[#0a0a1a] border border-white/10 rounded-xl text-white appearance-none focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all outline-none"
                  >
                    <option value="" className="bg-[#0a0a1a]">Selecione</option>
                    <option value="ODONTOLOGIA" className="bg-[#0a0a1a]">Odontologia</option>
                    <option value="MEDICINA" className="bg-[#0a0a1a]">Medicina</option>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {tiposProdutos.map((tipo) => (
                    <button
                      ...
                      className={`p-4 rounded-xl border font-medium transition-all ${formData.tipo_produtos.includes(tipo.value)
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <div className={`w-5 h-5 rounded border flex items-center justify-center ${formData.tipo_produtos.includes(tipo.value)
                        ...
                        <span className="text-sm text-left">{tipo.label}</span>
                      </div>
                    </button>
                  ))}
                </div>
            ...
            <div className="flex justify-end pt-4">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-brand-coral to-brand-orange text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-brand-coral/20 hover:scale-[1.02] transition-all flex items-center gap-2"
              >
                Próxima Etapa
        ...
        {etapa === 2 && (
          <div className="bg-[#13132B]/80 backdrop-blur-sm border border-white/10 rounded-3xl shadow-xl p-6 space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-black text-white">Contato e Endereço</h2>
                <p className="text-gray-400">Dados para comunicação</p>
              </div>
            </div>

            {/* Responsável */}
            <div className="bg-[#0a0a1a] border border-white/5 rounded-2xl p-4 mb-4">
              <h3 className="font-bold text-brand-coral mb-3">Responsável pela Empresa</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-gray-300 mb-2">
                    Nome Completo *
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#13132B] border border-white/10 rounded-xl text-white placeholder-gray-600 focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all outline-none"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-300 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex">
                  <span className="inline-flex items-center px-4 bg-[#13132B] border border-r-0 border-white/10 rounded-l-xl text-gray-400 font-medium">
                    @
                  </span>
                  <input
                    type="text"
                    ...
                    className="flex-1 px-4 py-4 bg-[#0a0a1a] border border-white/10 rounded-r-xl text-white placeholder-gray-600 focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all outline-none"
            ...
            {/* Endereço */}
            <div className="bg-[#0a0a1a] border border-white/5 rounded-2xl p-4">
              <h3 className="font-bold text-brand-orange mb-3">Endereço</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  />
                  {buscandoCep && <p className="text-xs text-brand-coral mt-1">Buscando CEP...</p>}
                </div>
            ...
            <div className="flex justify-between pt-4">
              <button
                onClick={voltarEtapa}
                className="px-8 py-4 bg-[#0a0a1a] border border-white/10 text-white font-bold rounded-2xl hover:bg-white/5 transition-all flex items-center gap-2"
              >
                <ChevronLeft className="w-5 h-5" />
                Voltar
              </button>
        ...
        {etapa === 3 && (
          <div className="bg-[#13132B]/80 backdrop-blur-sm border border-white/10 rounded-3xl shadow-xl p-6 space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-black text-white">Documentos</h2>
                <p className="text-gray-400">Envie os documentos necessários</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="logo-upload"
                  className={`flex items-center justify-center gap-3 w-full px-4 py-8 border-2 border-dashed border-white/20 bg-[#0a0a1a] rounded-xl cursor-pointer hover:border-brand-coral/50 hover:bg-white/5 transition-all ${uploadingLogo ? "opacity-50 cursor-not-allowed" : ""
                    }`}
                >
                  {uploadingLogo ? (
                    <>
                      <Loader2 className="w-6 h-6 text-brand-orange animate-spin" />
                      <span className="text-gray-400 font-medium">Enviando logo...</span>
                    </>
                  ) : formData.logo_url ? (
                    <>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="doc-upload"
                  className={`flex items-center justify-center gap-3 w-full px-4 py-8 border-2 border-dashed rounded-xl cursor-pointer transition-all ${uploadingDoc ? "border-white/20 opacity-50 cursor-not-allowed" :
                      formData.contrato_social_url ? "border-green-500/50 bg-green-500/10" :
                ...
                >
                  {uploadingDoc ? (
                    <>
                      <Loader2 className="w-6 h-6 text-brand-orange animate-spin" />
                      <span className="text-gray-400 font-medium">Enviando documento...</span>
                    </>
            ...
            <div className="bg-brand-coral/5 border border-brand-coral/20 rounded-xl p-6 space-y-4">
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
              <div className="flex gap-3">
                ...
                <div className="text-sm text-blue-200">
                  <p className="font-bold mb-1 text-blue-100">Análise de Cadastro</p>
                  <p>
            ...
            <div className="flex justify-between pt-4">
              ...
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-green-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
