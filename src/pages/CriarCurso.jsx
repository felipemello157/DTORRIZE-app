...
export default function CriarCurso() {
  ...
  const validarFormulario = (status) => {
    ...
    if (!formData.inscricoes_ate) return "Informe a data limite de inscrições";
      ...
      <div className="max-w-4xl mx-auto p-6 relative z-10">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black text-white">Publicar Novo Curso</h1>
              <p className="text-gray-400">Crie e publique cursos e especializações</p>
            </div>
          </div>
        </div>
        ...
        <motion.div
          ...
          className="bg-[#13132B]/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-xl p-6 mb-6 space-y-6"
        >
          <h2 className="text-xl font-black text-white mb-4">Informações do Curso</h2>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all outline-none resize-none"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <select
                ...
                className="w-full px-4 py-4 bg-white/5 border border-white/10 rounded-xl text-white focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all outline-none disabled:opacity-50 [&>option]:bg-[#13132B]"
              >
        ...
        <motion.div
          ...
          className="bg-[#13132B]/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-xl p-6 mb-6 space-y-6"
        >
          <h2 className="text-xl font-black text-white mb-4">Detalhes</h2>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-black text-white">Valores</h2>
          </div>
          ...
          <div className="p-4 bg-brand-primary/10 rounded-xl border border-brand-primary/20">
            <label className="flex items-center justify-between cursor-pointer">
              <span className="text-sm font-bold text-white">Oferecer Parcelamento</span>
              <input
                type="checkbox"
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="500.00"
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all outline-none"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-300 mb-2">
          ...
          <div className="p-4 bg-green-900/10 rounded-xl border border-green-500/20">
            <label className="flex items-center justify-between cursor-pointer">
              <span className="text-sm font-bold text-white">Oferecer Desconto</span>
              <input
                type="checkbox"
                checked={formData.tem_desconto}
                onChange={(e) => setFormData({ ...formData, tem_desconto: e.target.checked })}
                className="w-5 h-5 accent-green-500 rounded bg-white/10 border-white/20"
              />
            </label>
              ...
              <div className="mt-4 space-y-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="10"
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all outline-none"
                  />
                </div>
                {formData.valor_com_desconto && (
                  <div className="p-3 bg-white/5 rounded-xl border border-white/10">
                    <p className="text-sm text-gray-400 mb-1">Valor com Desconto:</p>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-black text-white">Datas e Vagas</h2>
          </div>
        ...
        {(formData.modalidade === "PRESENCIAL" || formData.modalidade === "HIBRIDO") && (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-black text-white">Localização</h2>
            </div>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-black text-white">Imagens</h2>
          </div>
          ...
          <div>
            ...
            <label
              ...
              className={`flex items-center justify-center gap-3 w-full px-4 py-6 border border-dashed border-white/20 rounded-xl cursor-pointer hover:border-brand-primary hover:bg-white/5 transition-all ${uploadingPrincipal ? "opacity-50 cursor-not-allowed" : "bg-white/5"
                }`}
            >
              {uploadingPrincipal ? (
                <>
                ...
                <>
                  ...
                  <span className="text-green-500 font-medium">Imagem enviada ✓</span>
                </>
              ) : (
                <>
                  <Upload className="w-6 h-6 text-gray-400" />
                  <span className="text-gray-400 font-medium">Clique para enviar (máx. 5MB)</span>
                </>
              )}
            </label>
          </div>
          ...
          <div>
            ...
            <label
              ...
              className={`flex items-center justify-center gap-3 w-full px-4 py-6 border border-dashed border-white/20 rounded-xl cursor-pointer hover:border-brand-primary hover:bg-white/5 transition-all ${uploadingExtras || formData.imagens_extras.length >= 4 ? "opacity-50 cursor-not-allowed" : "bg-white/5"
                }`}
            >
              {uploadingExtras ? (
                <>
        ...
        >
          <button
            ...
            className="flex-1 py-4 border border-white/10 text-white font-bold rounded-2xl hover:bg-white/5 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            disabled={criarCursoMutation.isPending}
            className="flex-1 py-4 bg-gradient-to-r from-brand-primary to-purple-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl shadow-brand-primary/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
